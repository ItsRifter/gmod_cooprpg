...
HL2C_Map.Checkpoints = {
	...
	{ min=Vector(7005.2,1280.4,-320.0),max=Vector(7051.2,1600.0,-496.8),spawn=Vector(6991.0,1567.2,-438.7),angle=Angle(4.4,-2.1,0.0), func = function() HL2C_Server:SetVehicle(VEHC_AIRBOAT) end, dist = 1024 },
}
...
HL2C_Map.Exit = { min=Vector(-4137.4,-2496.0,-509.9),max=Vector(-4212.7,-2112.0,-321.0), func = function(cp,ply)
	ply:UpdateAchievementProgress("HL2_Canals", 5)
end }
...
HL2C_Map.MapStartup = function()
	HL2C_Server:SetVehicle(VEHC_NONE)	--Make sure it starts off
