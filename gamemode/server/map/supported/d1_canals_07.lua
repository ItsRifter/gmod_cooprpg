...
HL2C_Map.Checkpoints = {
	...
	{ min=Vector(7106.5,1501.7,-320.0),max=Vector(7537.1,1414.0,-131.3),spawn=Vector(7133.4,1518.4,-320.0),angle=Angle(2.9,-18.7,0.0), dist = 512},
...
HL2C_Map.MapStartup = function()
	...
	HL2C_Map:RemoveMapEnts({1503,1532,1533,1510,1509,1506,1508,1507,1505,2669,2239})	
