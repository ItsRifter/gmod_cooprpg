HL2C_Map.Weapons = {"weapon_crowbar","weapon_pistol","weapon_smg1","weapon_frag"}
HL2C_Map.Loadout = {armour = 40,Pistol = 27,SMG1 = 45,Grenade=2}
HL2C_Map.Flags = {}
...
HL2C_Map.Exit = { min=Vector(-9201.8,8389.0,-579.3),max=Vector(-8816.0,8247.5,-357.8), func = function(cp,ply)
	ply:UpdateAchievementProgress("HL2_Canals", 8)
end }
